    ...
    <>
      <div className="md:flex justify-between py-4 md:px-12 ">
        <div className=" md:flex items-center gap-4">
          <div className=" flex justify-between md:flex md:items-center md:gap-4">
            <RiMenu2Line className="text-white text-[30px]" />
            <img src="./kfc_logo.png" alt="" />
          </div>
          <div className="flex justify-between  md:flex items-center gap-4 mt-4">
            <div className="flex justify-center items-center gap-2 border-[2px] rounded-[5px] border-[red] bg-[#1C1816]     px-4 py-2">
